...
Чтобы перемещаться между разными версиями изменений можно взять из *git log* код (первые 5 символов) и запустить команду git checkout XXXXX - тогда вы перейдете к нужной версии документа.
